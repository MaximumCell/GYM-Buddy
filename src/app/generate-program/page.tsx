      ...
      try {
        ...
        const fullName = user?.firstName
          ...
          : "There";
           ...
           // Add this line to see what user?.id is
            // console.log("Frontend User ID to send to VAPI:", user?.id);
            // console.log("Frontend Full Name to send to VAPI:", fullName);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="space-y-3">
                {messages.map((msg, index) => (
                  ...
                  <div className="font-semibold text-xs text-muted-foreground mb-1">
                    {msg.role === "assistant" ? "GYM Buddy AI" : "You"}:
                  </div>
          ...
          <div className="w-full flex justify-center gap-4">
            <Button
              ...
              } text-white relative`} onClick={toggleCall} disabled={connecting || callEnded}
            >
              {connecting && (
